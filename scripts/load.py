...
class Load_dialog(widget.QWidget):
    ...
    def create_load_button(self):
        ...
        self.load_button.clicked.connect(self.load_selected_flashcards)
    ...
    def load_selected_flashcards(self):
        ...
        self.main_window.update_main_window_parameters(file_path, data)
